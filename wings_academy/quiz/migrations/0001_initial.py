# Generated by Django 3.1.2 on 2021-06-15 18:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('mains', 'mains'), ('preliminary', 'preliminary'), ('foundation', 'foundation'), ('free', 'free')], max_length=20, null=True, unique=True, verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('mains', 'mains'), ('preliminary', 'preliminary'), ('foundation', 'foundation'), ('free', 'free')], default='foundation', max_length=20)),
